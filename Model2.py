...
class Encoder(torch.nn.Module):
    ...
    def __init__(self, latent_dimension):
        ...
        self.conv4 = torch.nn.Conv2d(64, 128, kernel_size=4, stride=2, padding=1).to(device)
        self.relu4 = torch.nn.ReLU().to(device)
        self.conv5 = torch.nn.Conv2d(128, 256, kernel_size=4, stride=2, padding=1).to(device)
        self.relu5 = torch.nn.ReLU().to(device)
        self.conv6 = torch.nn.Conv2d(256, 512, kernel_size=4, stride=2, padding=1).to(device)
...
class Decoder(torch.nn.Module):
    ...
    def __init__(self, latent_dimension):
        ...
        self.relu2 = torch.nn.ReLU().to(device)
        self.conv3 = torch.nn.ConvTranspose2d(128, 64, kernel_size=4, stride=2, padding=1).to(device)
        self.relu3 = torch.nn.ReLU().to(device)
        self.conv4 = torch.nn.ConvTranspose2d(64, 16, kernel_size=4, stride=2, padding=1).to(device)
        self.relu4 = torch.nn.ReLU().to(device)
        self.conv5 = torch.nn.ConvTranspose2d(16, 16, kernel_size=3, stride=1, padding=1).to(device)
        self.relu5 = torch.nn.ReLU().to(device)
        self.conv6 = torch.nn.ConvTranspose2d(16, 3, kernel_size=4, stride=2, padding=1).to(device)
